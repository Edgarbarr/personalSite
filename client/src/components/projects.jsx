...
function Projects(){
    return (
        <div className="container-fluid">
            <div className="row row-cols-2 blk">
                <video className="fadein col-sm-8" width="820" height="740" autoPlay loop muted>
                    <source src="Trafalgar.mp4" type="video/mp4"/>
                    Your browser does not support the video tag.
                </video>
                <div className="col-sm-4 margin-auto font-white fadein">
            ...
            <div className="row row-cols-2 wte">
                <video className="fadein col-sm-8" width="820" height="740" autoPlay loop muted>
                    <source src="systemdesign.mp4" type="video/mp4"/>
                    Your browser does not support the video tag.
                </video>
                <div className="col-sm-4 margin-auto fadein">
            ...
            <div className="row row-cols-2 blk">
                ...
                <div className="col-sm-4 font-white margin-auto fadein">
                    <h2>Trivia Game</h2>
